...
class Parser(object):
    ...
    def parse_sentence(self, words, pos):
        ...
        while state.buffer:
          ...
          Transition_scores=self.model(feature_tensor)
          Transition_scores=Transition_scores.detach().numpy()[0]
          sorted_scores= np.argsort(-Transition_scores)
          ...
          for i in sorted_scores:
              ...
              if transition=='shift':
                ...
                if len(state.stack) > 0 and label != 'root':
